...
define('vs/language/json/jsonMode', ['require', 'require'], (require) => {
  ...
  var moduleExports = (() => {
      ...
      G = (e, r, i, t) => {
        if ((r && typeof r == 'object') || typeof r == 'function')
          for (let n of Gn(r))
            !Cn.call(e, n) &&
              n !== i &&
              Z(e, n, { get: () => r[n], enumerable: !(t = Yn(r, n)) || t.enumerable });
        return e;
      },
      Re = (e, r, i) => (G(e, r, 'default'), i && G(i, r, 'default')),
      We = (e, r, i) => (
        (i = e != null ? Qn(Zn(e)) : {}),
        G(r || !e || !e.__esModule ? Z(i, 'default', { value: e, enumerable: !0 }) : i, e)
      ),
    ...
    (function (e) {
      function r(t, n) {
        return (
          ...
          n === Number.MAX_VALUE && (n = C.MAX_VALUE),
          { line: t, character: n }
        );
      }
      e.create = r;
    ...
    (function (e) {
      function r(t, n, o, s) {
        if (a.uinteger(t) && a.uinteger(n) && a.uinteger(o) && a.uinteger(s))
          return { start: E.create(t, n), end: E.create(o, s) };
      ...
      function i(t) {
        ...
        return (
          ...
          (a.undefined(o.codeDescription) ||
            a.string((n = o.codeDescription) === null || n === void 0 ? void 0 : n.href)) &&
        ...
        return (
          ...
          (t.documentChanges === void 0 ||
            t.documentChanges.every((n) =>
              a.string(n.kind) ? ge.is(n) || pe.is(n) || me.is(n) : de.is(n)
            ))
        );
      }
      e.is = r;
    ...
    (function (e) {
      function r(i, t, ...n) {
        let o = { label: i };
        return (
          a.defined(t) && (o.documentation = t),
          a.defined(n) ? (o.parameters = n) : (o.parameters = []),
          o
        );
      }
      e.create = r;
    ...
    (function (e) {
      ...
      function i(t) {
        ...
        return (
          ...
          (n.triggerKind === void 0 ||
            n.triggerKind === ie.Invoked ||
            n.triggerKind === ie.Automatic)
        );
      }
      e.is = i;
    })(un || (un = {}));
    ...
    (function (e) {
      ...
      function n(o, s) {
        ...
        let g = 0,
          c = 0,
          y = 0;
        for (; g < f.length && c < m.length; )
          s(f[g], m[c]) <= 0 ? (o[y++] = f[g++]) : (o[y++] = m[c++]);
        ...
        let n = (s) => {
            ...
            ((this._listener[s.uri.toString()] = s.onDidChangeContent(() => {
              (window.clearTimeout(f),
                (f = window.setTimeout(() => this._doValidate(s.uri, l), 500)));
            })),
            ...
            let l = r.getWordUntilPosition(i),
              ...
              m = s.items.map((g) => {
                ...
                return (
                  g.textEdit &&
                    (ut(g.textEdit)
                      ? (c.range = { insert: v(g.textEdit.insert), replace: v(g.textEdit.replace) })
                      : (c.range = v(g.textEdit.range)),
                    (c.insertText = g.textEdit.newText)),
                  g.additionalTextEdits && (c.additionalTextEdits = g.additionalTextEdits.map(M)),
                  g.insertTextFormat === te.Snippet &&
                    (c.insertTextRules = u.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                  c
                );
              });
      ...
      for (let i in e.changes) {
        ...
        for (let n of e.changes[i])
          r.push({
            resource: t,
            versionId: void 0,
            textEdit: { range: v(n.range), text: n.newText },
          });
      }
      return { edits: r };
    }
            ...
            .then((o) => {
              if (o)
                return o.map((s) => {
                  let l = { label: s.label };
                  return (
                    s.textEdit && (l.textEdit = M(s.textEdit)),
                    s.additionalTextEdits && (l.additionalTextEdits = s.additionalTextEdits.map(M)),
                    l
                  );
                });
            });
    ...
    function oe(e, r = !1) {
      ...
      function A() {
        ...
        if (t < e.length && e.charCodeAt(t) === 46)
          if ((t++, t < e.length && j(e.charCodeAt(t))))
...
`)),
        ...
        switch (d) {
          ...
          case 45:
            if (((n += String.fromCharCode(d)), t++, t === i || !j(e.charCodeAt(t))))
              return (s = 16);
          case 48:
          case 49:
          case 50:
...
` + '	'.repeat(r)
    ...
    function zn(e) {
      return {
        getInitialState: () => new se(null, null, !1, null),
        tokenize: (r, i) => jt(e, r, i),
      };
    }
      ...
      se = class e {
        ...
        equals(r) {
          return r === this
            ...
            : !r || !(r instanceof e)
              ? !1
              : this.scanError === r.scanError &&
                this.lastWasColon === r.lastWasColon &&
                P.equals(this.parents, r.parents);
        }
        getStateData() {
          return this._state;
        }
    ...
    function jt(e, r, i, t = 0) {
      ...
      for (;;) {
        ...
        ((m.endState = new se(i.getStateData(), s.getTokenError(), l, f)),
          m.tokens.push({ startIndex: g, scopes: c }));
      }
      return m;
    }
    var w;
    ...
    function Vt(e) {
      ...
      function n() {
        ...
        (Kn(i),
          l.documentFormattingEdits &&
            i.push(u.languages.registerDocumentFormattingEditProvider(s, new $(w))),
          l.documentRangeFormattingEdits &&
            i.push(u.languages.registerDocumentRangeFormattingEditProvider(s, new K(w))),
          l.completionItems &&
            i.push(u.languages.registerCompletionItemProvider(s, new H(w, [' ', ':', '"']))),
