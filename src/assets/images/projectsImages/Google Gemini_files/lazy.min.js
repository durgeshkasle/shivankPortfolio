(function () {
  ...
  var ja = ea,
    ...
    w = function (a) {
      ...
      if (typeof a.length == 'number') return { next: ka(a) };
  ...
  var ta = function (a, b, c, d) {
      try {
        ...
        return ((a.context_.yieldAllIterator_ = null), a.context_.throw_(g), ua(a));
      }
    ...
    ua = function (a) {
      for (; a.context_.nextAddress; )
        try {
          ...
          if (b) return ((a.context_.isRunning_ = !1), { value: b.value, done: !1 });
        } catch (c) {
          ((a.context_.yieldResult = void 0), a.context_.throw_(c));
        }
  ...
  t('Promise', function (a) {
    ...
    e.prototype.resolveToNonPromiseObj_ = function (g) {
      ...
      typeof h == 'function' ? this.settleSameAsThenable_(h, g) : this.fulfill_(g);
    };
    ...
    e.prototype.settle_ = function (g, h) {
      if (this.state_ != 0)
        throw Error(
          'Cannot settle(' + g + ', ' + h + '): Promise already settled in state' + this.state_
        );
      this.state_ = g;
      this.result_ = h;
    ...
    e.prototype.scheduleUnhandledRejectionCheck_ = function () {
      ...
      d(function () {
        if (g.notifyUnhandledRejection_()) {
          var h = da.console;
          typeof h !== 'undefined' && h.error(g.result_);
        }
      }, 1);
    };
    ...
    e.prototype.callWhenSettled_ = function (g, h) {
      ...
      var l = this;
      this.onSettledCallbacks_ == null ? f.asyncExecute(k) : this.onSettledCallbacks_.push(k);
    ...
    e.race = function (g) {
      return new e(function (h, k) {
        for (var l = w(g), n = l.next(); !n.done; n = l.next()) c(n.value).callWhenSettled_(h, k);
      });
    };
    e.all = function (g) {
      var h = w(g),
  ...
  t('WeakMap', function (a) {
    ...
    h.prototype.set = function (k, l) {
      ...
      d(k);
      if (!y(k, f)) throw Error('WeakMap key fail: ' + k);
      k[f][this.id_] = l;
      return this;
    };
    h.prototype.get = function (k) {
      return c(k) && y(k, f) ? k[f][this.id_] : void 0;
    };
    h.prototype.has = function (k) {
      return c(k) && y(k, f) && y(k[f], this.id_);
    };
    h.prototype.delete = function (k) {
      return c(k) && y(k, f) && y(k[f], this.id_) ? delete k[f][this.id_] : !1;
    };
    return h;
  });
  t('Map', function (a) {
        ...
        if (n && y(h[0], l))
          for (h = 0; h < n.length; h++) {
            ...
            if ((k !== k && q.key !== q.key) || k === q.key)
              return { id: l, list: n, index: h, entry: q };
          }
  ...
  t('Set.prototype.isSubsetOf', function (a) {
    return a
      ...
      : function (b) {
          ...
          for (var c = this.keys(), d = c.next(); !d.done; ) {
            if (!b.has(d.value)) return !1;
            d = c.next();
          }
          return !0;
        };
...
*/
  ...
  function Qa() {
    ...
    try {
      ...
      a = Oa.createPolicy('uf-la#html', { createHTML: b, createScript: b, createScriptURL: b });
    } catch (c) {}
    return a;
  }
  var Ra = function (a) {
  ...
  function Ta(a) {
    if (a instanceof Ra) return a.privateDoNotAccessOrElseWrappedResourceUrl;
    throw Error('');
  }
  var Ua = function (a) {
  ...
  function Wa(a) {
    if (a instanceof Ua) return a.privateDoNotAccessOrElseWrappedUrl;
    throw Error('');
  }
  function B(a, b) {
  ...
  var pb = ob('jas', void 0, !0),
    qb = ob(void 0, Symbol()),
    sb = ob(void 0, '0ub'),
    tb = ob(void 0, '0ubs'),
    ub = ob(void 0, '0actk'),
    vb = ob('m_m', 'messagePrototypeMarker', !0),
    wb = ob();
  Math.max.apply(
    Math,
    la(
  ...
  var xb = { internalArrayState: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
    yb = Object.defineProperties,
    C = nb ? pb : 'internalArrayState',
    zb,
    Ab = [];
  E(Ab, 7);
  zb = Object.freeze(Ab);
  ...
  function Eb(a, b) {
    return b === void 0
      ? a.copyOnWrite !== Fb &&
          !!(2 & (a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows[C] | 0))
      : !!(2 & b) && a.copyOnWrite !== Fb;
  }
  var Fb = {},
    Gb = Object.freeze({});
  function Hb(a) {
  ...
  function F(a) {
    ...
    } else if (Jb(b) && !Number.isSafeInteger(b)) throw Error(String(b));
    return Nb ? BigInt(a) : (a = Lb(a) ? (a ? '1' : '0') : Kb(a) ? a.trim() || '0' : String(a));
  }
  var Ob = Ib(function (a) {
      return Nb ? Mb(a) : Kb(a) && /^(?:-?[1-9]\d*|0)$/.test(a);
    }),
    Ub = Ib(function (a) {
      return Nb ? a >= Pb && a <= Qb : a[0] === '-' ? Rb(a, Sb) : Rb(a, Tb);
    }),
    Sb = Number.MIN_SAFE_INTEGER.toString(),
    Pb = Nb ? BigInt(Number.MIN_SAFE_INTEGER) : void 0,
    Tb = Number.MAX_SAFE_INTEGER.toString(),
    Qb = Nb ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
  function Rb(a, b) {
  ...
  function $b() {
    ...
    b & 2147483648
      ? Cb()
        ...
        : ((b = w(Xb(a, b))), (a = b.next().value), (b = b.next().value), (a = '-' + Yb(a, b)))
      : (a = Yb(a, b));
    return a;
  }
  function Xb(a, b) {
  ...
  function dc(a, b) {
    if (a != null) {
      ...
      c = d[a] || 0;
      c >= b || ((d[a] = c + 1), (a = Error()), ac(a, 'incident'), Ya(a));
    }
  }
  function ec(a) {
    return Array.prototype.slice.call(a);
  }
  var fc = typeof BigInt === 'function' ? BigInt.asIntN : void 0,
  ...
  function nc(a) {
    if (!ic(a)) throw cc('enum');
    return a | 0;
  }
  function oc(a) {
    return a == null ? a : ic(a) ? a | 0 : void 0;
  }
  function pc(a) {
    if (typeof a !== 'number') throw cc('int32');
    if (!ic(a)) throw cc('int32');
    return a | 0;
  }
  function qc(a) {
    var b = 0;
    b = b === void 0 ? 0 : b;
    if (!mc(a)) throw cc('int64');
    var c = typeof a;
    switch (b) {
      case 512:
        switch (c) {
    ...
    if (a.length < 16) Wb(Number(a));
      ...
      for (var c = a.length, d = 0 + b, e = ((c - b) % 6) + b; e <= c; d = e, e += 6)
        ((d = Number(a.slice(d, e))),
          (H *= 1e6),
          (G = G * 1e6 + d),
          G >= 4294967296 && ((H += Math.trunc(G / 4294967296)), (H >>>= 0), (G >>>= 0)));
      b && ((b = w(Xb(G, H))), (a = b.next().value), (b = b.next().value), (G = a), (H = b));
    }
    return $b();
  }
  function vc(a) {
  ...
  function sc(a) {
    mc(a);
    a = jc(a);
    hc(a) ? (a = String(a)) : (Wb(a), (a = $b()));
    return a;
  }
  function rc(a) {
    mc(a);
    var b = jc(Number(a));
    if (hc(b)) return String(b);
    b = a.indexOf('.');
  ...
  function tc(a) {
    ...
    b = a.indexOf('.');
    b !== -1 && (a = a.substring(0, b));
    return Cb() ? F(fc(64, BigInt(a))) : F(wc(a));
  }
  function uc(a) {
    return hc(a) ? F(vc(a)) : F(sc(a));
  }
  function xc(a) {
  ...
  function Ac(a, b, c) {
    ...
    d &&
      ...
      (d = Ma(qb)) && d in a && (a = a[d]) && delete a[b]);
  }
  function Bc(a, b) {
    var c = Ma(qb),
      d;
    nb && c && ((d = a[c]) == null ? void 0 : d[b]) != null && dc(sb, 3);
  }
  function Cc(a, b) {
    b < 100 || dc(tb, 1);
  }
  function Dc(a, b, c, d) {
    ...
    var f = Ma(qb),
      g;
    !e && nb && f && (g = a[f]) && g.forEachUnknownField(Cc);
    f = [];
    var h = a.length;
    g = 4294967295;
    var k = !1,
    ...
    if (!(b & 1)) {
      ...
      if (l && !(b & 128) && !e) {
        k = !0;
        var r;
        g = ((r = Ec) != null ? r : Hb)(g - n, n, a, q, void 0) + n;
      }
    }
    b = void 0;
    for (e = 0; e < h; e++)
      if (((r = a[e]), r != null && (r = c(r, d)) != null))
        if (l && e >= g) {
          var p = e - n,
            v = void 0;
          ((v = b) != null ? v : (b = {}))[p] = r;
      ...
      for (var D in q)
        ((a = q[D]),
          a != null &&
            ...
            ((h = +D),
            (e = void 0),
            l && !Number.isNaN(h) && (e = h + n) < g
              ? (f[e] = a)
              : ((h = void 0), (((h = b) != null ? h : (b = {}))[D] = a))));
    b && (k ? f.push(b) : (f[g] = b));
    return f;
  }
  function Fc(a) {
  ...
  function Jc(a, b) {
    ...
    if (a != null && a[vb] === Db)
      return (
        ...
        (c = b[C] | 0),
        Eb(a, c) ? a : Lc(a, b, c) ? Mc(a, b) : Kc(b, c)
      );
  }
  function Mc(a, b, c) {
  ...
  function Lc(a, b, c) {
    return c & 2 ? !0 : c & 32 && !(c & 4096) ? (E(b, c | 2), (a.copyOnWrite = Fb), !0) : !1;
  }
  var Qc = F(0),
    Rc = {},
    Tc = function (a, b, c, d) {
      ...
      if (b !== null || (d && a.noLegacyNull !== Fb)) return b;
    },
    Sc = function (a, b, c, d) {
      if (b === -1) return null;
      var e = b + (c ? 0 : -1),
  ...
  function Uc(a, b, c, d) {
    ...
    if (d !== void 0) {
      var h;
      f = (((h = b) != null ? h : (b = a[C] | 0)) >> 14) & 1023 || 536870912;
  ...
  function Wc(a, b, c, d, e) {
    ...
    d === 2 &&
      Nc(a) &&
      ((f = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows), (g = f[C] | 0));
    a = Sc(f, b);
    ...
    a = 4 & l ? !1 : !0;
    if (a) {
      4 & l && ((h = ec(h)), (k = 0), (l = Xc(l, g)), (g = Uc(f, g, b, h)));
    ...
    l !== k && (E(h, l), 2 & l && Object.freeze(h));
    c = h;
    k = h = l;
    d === 1 || (d !== 4 ? 0 : 2 & h || (!(16 & h) && 32 & g))
      ? Yc(h) ||
        ((h |= !c.length || (a && !(4096 & h)) || (32 & g && !(4096 & h || 16 & h)) ? 2 : 256),
        h !== k && E(c, h),
        Object.freeze(c))
      : (d === 2 && Yc(h) && ((c = ec(c)), (k = 0), (h = Xc(h, g)), (g = Uc(f, g, b, c))),
        Yc(h) || (e || (h |= 16), h !== k && E(c, h)));
    2 & h || !(4096 & h || 16 & h) || Pc(f, g);
    return c;
  }
  function Yc(a) {
  ...
  function Zc(a, b, c, d) {
    ...
    var e = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
      f = e[C] | 0;
    if (c == null) return (Uc(e, f, b), a);
    if (!Array.isArray(c)) throw cc();
    var g = c === zb ? 7 : c[C] | 0,
      h = g,
      k = Yc(g),
      l = k || Object.isFrozen(c);
    k || (g = 0);
    l || ((c = ec(c)), (h = 0), (g = Xc(g, f)), (l = !1));
    g |= 5;
    k = 4 & g ? (512 & g ? 512 : 1024 & g ? 1024 : 0) : void 0;
    k = k != null ? k : 0;
    for (var n = 0; n < c.length; n++) {
      var q = c[n],
        r = d(q, k);
      Object.is(q, r) || (l && ((c = ec(c)), (h = 0), (g = Xc(g, f)), (l = !1)), (c[n] = r));
    }
    g !== h && (l && ((c = ec(c)), (g = Xc(g, f))), E(c, g));
    Uc(e, f, b, c);
    return a;
  }
  function K(a, b, c, d) {
    Oc(a);
    var e = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows;
    Uc(e, e[C] | 0, b, (d === '0' ? Number(c) === 0 : c === d) ? void 0 : c);
    return a;
  }
  function $c(a, b, c, d, e) {
    var f = !1;
    d = Sc(a, d, e, function (g) {
      if (g != null && g[vb] === Db) var h = g;
    ...
    if (d != null) return (f && !Eb(d) && Pc(a, b), d);
  }
  var L = function (a, b, c) {
      ...
      if (!Eb(a, e)) {
        ...
        var g = f.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
          h = g[C] | 0;
        f = Eb(f, h) ? (Lc(f, g, h) ? Mc(f, g, !0) : new f.constructor(Kc(g, h, !1))) : f;
        f !== b &&
          (Nc(a) &&
            ((d = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows), (e = d[C] | 0)),
          (b = f),
          (e = Uc(d, e, c, b)),
          Pc(d, e));
      }
    ...
    M = function (a, b, c, d) {
      ...
      Vc(a, c, d);
      d && !Eb(d) && Pc(a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows);
      return a;
    };
  function Xc(a, b) {
  ...
  var N = function (a, b) {
    ...
    cd = function (a) {
      return Wc(a, 4, oc, void 0 === Gb ? 2 : 4);
    },
    P = function (a, b, c) {
  ...
  Q.prototype.getExtension = function (a) {
    ...
    return a.ctor
      ? a.isRepeated
        ? a.getExtensionFn(this, a.ctor, a.fieldIndex, void 0 === Gb ? 2 : 4, a.hasMessageId)
        : a.getExtensionFn(this, a.ctor, a.fieldIndex, a.hasMessageId)
      : a.isRepeated
        ? a.getExtensionFn(this, a.fieldIndex, void 0 === Gb ? 2 : 4, a.hasMessageId)
        : a.getExtensionFn(this, a.fieldIndex, a.defaultValue, a.hasMessageId);
  };
  Q.prototype.hasExtension = function (a) {
    ...
    if (a.ctor) {
      ...
      a = $c(b, b[C] | 0, a.ctor, a.fieldIndex, a.hasMessageId) !== void 0;
    } else
      (Bc(this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows, a.fieldIndex),
        Ac(this, a.fieldIndex, a.lazyParse),
        (a = a.ctor
          ? a.getExtensionFn(this, a.ctor, a.fieldIndex, a.hasMessageId)
          : a.getExtensionFn(this, a.fieldIndex, null, a.hasMessageId)),
  ...
  Q.prototype.clone = function () {
    var a = this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
      b = a[C] | 0;
    return Lc(this, a, b) ? Mc(this, a, !0) : new this.constructor(Kc(a, b, !1));
  };
  Q.prototype[vb] = Db;
  ...
  var ld = function (a) {
      return a instanceof kd &&
        a.constructor === kd &&
        a.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ === jd
        ? a.stringConstValueWithSecurityContract__googStringSecurityPrivate_
        : 'type_error:Const';
    },
    R = function (a) {
      return new kd(id, a);
  ...
  function pd(a) {
    var b = b === void 0 ? od : b;
    a: if (((b = b === void 0 ? od : b), !(a instanceof Ua))) {
  ...
  function rd(a) {
    a = a instanceof Ua ? Wa(a) : qd.test(a) ? a : void 0;
    return a;
  }
  function sd(a, b) {
    b = rd(b);
    b !== void 0 && a.open(b, void 0, void 0);
  }
  function td(a) {
  ...
  function ud(a, b) {
    a.src = Ta(b);
    (b = td(a.ownerDocument)) && a.setAttribute('nonce', b);
  }
  var vd =
  ...
  var yd = function (a) {
      return a ? new wd(xd(a)) : Xa || (Xa = new wd());
    },
    Ad = function (a, b) {
      ed(b, function (c, d) {
        d == 'style'
  ...
  U.prototype.then = function (a, b, c) {
    return $d(
      this,
      T(typeof a === 'function' ? a : null),
      T(typeof b === 'function' ? b : null),
      c
    );
  };
  ...
  var de = function (a, b) {
      if (a.state_ == 0)
        if (a.parent_) {
          ...
          if (c.callbackEntries_) {
            for (
              var d = 0, e = null, f = null, g = c.callbackEntries_;
            ...
            e &&
              (c.state_ == 0 && d == 1
                ...
                : (f
                    ? ((d = f),
                      d.next == c.callbackEntriesTail_ && (c.callbackEntriesTail_ = d),
                      (d.next = d.next.next))
                    : ee(c),
                  fe(c, e, 3, b)));
          }
    ...
    ae = function (a, b) {
      a.callbackEntries_ || (a.state_ != 2 && a.state_ != 3) || ge(a);
  ...
  var Td = function (a, b, c) {
      if (a.state_ == 0) {
        ...
        a: {
          var d = c,
            e = a.unblockAndFulfill_,
            f = a.unblockAndReject_;
          if (d instanceof U) {
            be(d, e, f, a);
            var g = !0;
          } else if (Sd(d)) (d.then(e, f, a), (g = !0));
          else {
            if (Ia(d))
              try {
                var h = d.then;
    ...
    ge = function (a) {
      a.executing_ || ((a.executing_ = !0), Od(a.executeCallbacks_, a));
    },
    ee = function (a) {
      var b = null;
      a.callbackEntries_ &&
  ...
  U.prototype.executeCallbacks_ = function () {
    for (var a; (a = ee(this)); ) fe(this, a, this.state_, this.result_);
    this.executing_ = !1;
  };
  var fe = function (a, b, c, d) {
      if (c == 3 && b.onRejected && !b.always)
        for (; a && a.hadUnhandledRejection_; a = a.parent_) a.hadUnhandledRejection_ = !1;
      if (b.child) ((b.child.parent_ = null), je(b, c, d));
      else
        try {
          b.always ? b.onFulfilled.call(b.context) : je(b, c, d);
        } catch (e) {
          ke.call(null, e);
        }
      Vd.put(b);
    ...
    je = function (a, b, c) {
      b == 2 ? a.onFulfilled.call(a.context, c) : a.onRejected && a.onRejected.call(a.context, c);
    },
    ie = function (a, b) {
      a.hadUnhandledRejection_ = !0;
      Od(function () {
        a.hadUnhandledRejection_ && ke.call(null, b);
      });
    },
    ke = Ya,
    ce = function (a) {
...
*/
  ...
  V.prototype.cancel = function (a) {
    if (this.fired_) this.result_ instanceof V && this.result_.cancel();
    else {
      if (this.parent_) {
        var b = this.parent_;
        delete this.parent_;
        a ? b.cancel(a) : (b.branches_--, b.branches_ <= 0 && b.cancel());
      }
      this.onCancelFunction_
        ? this.onCancelFunction_.call(this.defaultScope_, this)
        : (this.silentlyCanceled_ = !0);
      this.fired_ || ((a = new le(this)), me(this), ne(this, !1, a));
    }
  };
  ...
  var ne = function (a, b, c) {
    ...
    me = function (a) {
      if (a.fired_) {
        if (!a.silentlyCanceled_) throw new pe(a);
    ...
    oe = function (a) {
      if (a.unhandledErrorId_ && a.fired_ && te(a)) {
        var b = a.unhandledErrorId_,
          c = ue[b];
        c && (z.clearTimeout(c.id_), delete ue[b]);
        a.unhandledErrorId_ = 0;
      }
      a.parent_ && (a.parent_.branches_--, delete a.parent_);
      b = a.result_;
      for (var d = (c = !1); a.sequence_.length && !a.blocked_; ) {
        ...
        if ((f = a.hadError_ ? g : f))
          try {
            ...
            h === se && (h = void 0);
            h !== void 0 &&
              ((a.hadError_ = a.hadError_ && (h == b || h instanceof Error)), (a.result_ = b = h));
            if (Sd(b) || (typeof z.Promise === 'function' && b instanceof z.Promise))
              ((d = !0), (a.blocked_ = !0));
          } catch (k) {
            ((b = k), (a.hadError_ = !0), te(a) || (c = !0));
          }
      }
      a.result_ = b;
      d &&
        ((h = La(a.continue_, a, !0)),
        (d = La(a.continue_, a, !1)),
        b instanceof V ? (qe(b, h, d), (b.blocking_ = !0)) : b.then(h, d));
      c && ((b = new ve(b)), (ue[b.id_] = b), (a.unhandledErrorId_ = b.id_));
    },
    re = function (a) {
      var b = new V();
      a.then(
  ...
  var Ae = function () {
      var a = Sa('https://apis.google.com/js/client.js'),
        ...
        d = Ta(a).toString(),
        e = new wd(c).createElement('SCRIPT'),
        f = { script_: e, timeout_: void 0 },
        g = new V(we, f),
        h = null,
      ...
      e.onload = e.onreadystatechange = function () {
        (e.readyState && e.readyState != 'loaded' && e.readyState != 'complete') ||
          (xe(e, b.cleanupWhenDone || !1, h), g.callback(null));
      };
      e.onerror = function () {
        xe(e, !0, h);
      ...
      f = b.attributes || {};
      hd(f, { type: 'text/javascript', charset: 'UTF-8' });
      Ad(e, f);
      ud(e, a);
      ze(c).appendChild(e);
      return g;
    ...
    we = function () {
      if (this && this.script_) {
        var a = this.script_;
        a && a.tagName == 'SCRIPT' && xe(a, !0, this.timeout_);
      }
    },
    xe = function (a, b, c) {
  ...
  var Be = function (a) {
    var b = a.serverUrl;
    var c = a.apiKey;
    a = a.authUser === void 0 ? 0 : a.authUser;
    this.serverUrl_ = b;
    this.apiKey_ = c;
    this.authUser_ = a;
  };
  ...
  var Ce = function (a, b, c, d, e) {
      ...
      return ya(function (n) {
        if (n.nextAddress == 1) return ra(n, De(), 2);
        f = A('gapi.client');
        g = A('gapi.config');
        h = Ee();
        k = f.getToken();
        f.setToken(null);
        g.update('googleapis.config/auth/useFirstPartyAuth', !0);
        g.update('googleapis.config/auth/useFirstPartyAuthV2', !0);
        g.update('client/xd4', !1);
        g.update('client/cors', !1);
        ...
        l = f
          .request({
            ...
            path: c,
            method: b,
            body: d ? JSON.stringify(Gc(d)) : void 0,
            headers: {
    ...
    Ee = function () {
      var a = A('gapi.config'),
        b = {};
      b['googleapis.config/auth/useFirstPartyAuth'] = a.get(
        'googleapis.config/auth/useFirstPartyAuth'
      );
      b['googleapis.config/auth/useFirstPartyAuthV2'] = a.get(
    ...
    Fe = function (a) {
      for (var b = A('gapi.config'), c = w(Object.keys(a)), d = c.next(); !d.done; d = c.next())
        ((d = d.value), b.update(d, a[d]));
    },
    De = function () {
      return A('gapi.load')
        ? Ge()
  ...
  Ve.prototype.register = function (a, b, c) {
    this.actions_[a] = { callback: b, isApplicable: c || Qd };
  };
  Ve.prototype.execute = function (a, b) {
    (a = this.actions_[a]) && a.isApplicable() && a.callback.apply(null, b || []);
  };
  ...
  function Ze(a) {
    if (!a) return null;
    a = yc(Tc(a, 4, void 0, Rc));
    return a === null || a === void 0 ? null : Sa(a);
  }
  var $e = x(['']),
    af = x(['https://www.google.com/tools/feedback/help_panel_binary.js']);
  function bf(a, b, c, d) {
    ...
    g && k.setAttribute('nonce', g);
    k.onload = function () {
      c.startHelpCard({
        apiKey: '',
        context: a.helpCenterContext,
        directToGetHelp: !1,
        enableSendFeedback: !1,
        helpApiData: { helpApiConfig: a, productWindow: c },
        helpcenter: e,
        helpPanelStartTimeMs: a.helpPanelStartTimeMs,
        helpPanelTheme: a.helpPanelTheme,
        locale: a.locale,
        nd4cSettingsIsEnabled: !1,
  ...
  var cf = x(['https://www.google.com/tools/feedback/']),
    df = x(['http://localhost.corp.google.com/inapp/']),
    ef = x(['http://localhost.proxy.googlers.com/inapp/']),
    ff = x(['https://asx-frontend-autopush.corp.google.com/inapp/']),
    gf = x(['https://asx-frontend-autopush.corp.google.com/tools/feedback/']),
    hf = x(['https://asx-frontend-autopush.corp.google.co.uk/inapp/']),
    jf = x(['https://asx-frontend-autopush.corp.google.co.uk/tools/feedback/']),
    kf = x(['https://asx-frontend-autopush.corp.google.de/inapp/']),
    lf = x(['https://asx-frontend-autopush.corp.google.de/tools/feedback/']),
    mf = x(['https://asx-frontend-autopush.corp.youtube.com/tools/feedback/']),
    nf = x(['https://asx-frontend-autopush.corp.youtube.com/inapp/']),
    of = x(['https://asx-help-frontend-autopush.corp.youtube.com/tools/feedback/']),
    pf = x(['https://asx-help-frontend-autopush.corp.youtube.com/inapp/']),
    qf = x(['https://asx-frontend-staging.corp.google.com/inapp/']),
    rf = x(['https://asx-frontend-staging.corp.google.com/tools/feedback/']),
    sf = x(['https://support.google.com/inapp/']),
    tf = x(['https://sandbox.google.com/inapp/']),
    uf = x(['https://sandbox.google.com/tools/feedback/']),
    vf = x(['https://www.google.cn/tools/feedback/']),
    wf = x(['https://help.youtube.com/tools/feedback/']),
    xf = x(['https://asx-frontend-staging.corp.google.com/inapp/']),
    yf = x(['https://asx-frontend-staging.corp.google.com/tools/feedback/']),
    zf = x(['https://localhost.corp.google.com/inapp/']),
    Af = x(['https://localhost.proxy.googlers.com/inapp/']),
    Bf = S(cf),
    Cf = [S(df), S(ef)],
    Df = [S(ff), S(gf), S(hf), S(jf), S(kf), S(lf), S(mf), S(nf), S(of), S(pf)],
    Ef = [S(qf), S(rf)],
    Ff = [Bf, S(sf), S(tf), S(uf), S(vf), S(wf), S(xf), S(yf), S(zf), S(Af)];
  la(Cf);
  la(Df);
  la(Ef);
  la(Ff);
  ...
  Jf.prototype.init = function (a, b) {
    ...
    this.event_ = a;
    a.defaultPrevented && Jf.superClass_.preventDefault.call(this);
  };
  ...
  var Of = 'closure_listenable_' + ((Math.random() * 1e6) | 0);
  var Pf = 0;
  ...
  Sf.prototype.add = function (a, b, c, d, e) {
    ...
    g > -1
      ...
      : ((b = new Qf(b, this.src, f, !!d, e)), (b.callOnce = c), a.push(b));
    return b;
  };
  Sf.prototype.remove = function (a, b, c, d) {
    ...
    return b > -1
      ? (Rf(e[b]),
        ...
        e.length == 0 && (delete this.listeners[a], this.typeCount_--),
        !0)
      : !1;
  };
  var Uf = function (a, b) {
    ...
    c in a.listeners &&
      gb(a.listeners[c], b) &&
      (Rf(b), a.listeners[c].length == 0 && (delete a.listeners[c], a.typeCount_--));
  };
  ...
  var Vf = 'closure_lm_' + ((Math.random() * 1e6) | 0),
    ...
    Zf = function (a, b, c, d, e) {
      if (d && d.once) Yf(a, b, c, d, e);
      else if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Zf(a, b[f], c, d, e);
      else
        ((c = $f(c)),
          a && a[Of] ? a.listen(b, c, Ia(d) ? !!d.capture : !!d, e) : ag(a, b, c, !1, d, e));
    },
    ag = function (a, b, c, d, e, f) {
      ...
      if (!c.proxy) {
        ...
        if (a.addEventListener)
          (If || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e));
    ...
    Yf = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Yf(a, b[f], c, d, e);
      else
        ((c = $f(c)),
          a && a[Of]
            ? a.eventTargetListeners_.add(String(b), c, !0, Ia(d) ? !!d.capture : !!d, e)
            : ag(a, b, c, !0, d, e));
    },
    fg = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) fg(a, b[f], c, d, e);
      else
        ((d = Ia(d) ? !!d.capture : !!d),
          (c = $f(c)),
          a && a[Of]
            ? a.eventTargetListeners_.remove(String(b), c, d, e)
            : a && (a = bg(a)) && (b = a.getListener(b, c, d, e)) && gg(b));
    },
    gg = function (a) {
      if (typeof a !== 'number' && a && !a.removed) {
        var b = a.src;
        if (b && b[Of]) Uf(b.eventTargetListeners_, a);
        else {
          var c = a.type,
            d = a.proxy;
          ...
          Xf--;
          (c = bg(b)) ? (Uf(c, a), c.typeCount_ == 0 && ((c.src = null), (b[Vf] = null))) : Rf(a);
        }
      }
    },
    dg = function (a) {
    ...
    hg = '__closure_events_fn_' + ((Math.random() * 1e9) >>> 0),
    $f = function (a) {
  ...
  m.dispatchEvent = function (a) {
    ...
    if (b) {
      var c = [];
      for (var d = 1; b; b = b.parentEventTarget_) (c.push(b), ++d);
    }
    b = this.actualEventTarget_;
    d = a.type || a;
    if (typeof a === 'string') a = new Hf(a, b);
    else if (a instanceof Hf) a.target = a.target || b;
    else {
      var e = a;
      a = new Hf(d, b);
      hd(a, e);
    ...
    a.propagationStopped_ ||
      ((g = a.currentTarget = b),
      (e = jg(g, d, !0, a) && e),
      a.propagationStopped_ || (e = jg(g, d, !1, a) && e));
    if (c)
      for (f = 0; !a.propagationStopped_ && f < c.length; f++)
        ((g = a.currentTarget = c[f]), (e = jg(g, d, !1, a) && e));
    return e;
  };
  m.disposeInternal = function () {
    ...
    if (this.eventTargetListeners_) {
      ...
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) (++b, Rf(d[e]));
  ...
  var jg = function (a, b, c, d) {
    ...
    for (var e = !0, f = 0; f < b.length; ++f) {
      ...
      if (g && !g.removed && g.capture == c) {
        var h = g.listener,
          k = g.handler || g.src;
        g.callOnce && Uf(a.eventTargetListeners_, g);
        e = h.call(k, d) !== !1 && e;
      }
    }
  ...
  var ng = /^https?$/i,
    ...
    qg = function (a, b, c, d, e, f) {
      var g = new X();
      pg.push(g);
      b && g.listen('complete', b);
      g.eventTargetListeners_.add('ready', g.cleanupSend_, !0, void 0, void 0);
      f && (g.timeoutInterval_ = Math.max(0, f));
      g.withCredentials_ = !0;
      g.send(a, c, d, e);
    };
  m = X.prototype;
  ...
  m.send = function (a, b, c, d) {
    ...
    this.progressEventsEnabled_ &&
      ...
      ((this.xhr_.onprogress = T(
        La(function (g) {
          this.onProgressHandler_(g, !0);
        }, this)
      )),
      this.xhr_.upload && (this.xhr_.upload.onprogress = T(La(this.onProgressHandler_, this))));
    try {
  ...
  m.timeout_ = function () {
    typeof Da != 'undefined' && this.xhr_ && (this.dispatchEvent('timeout'), this.abort(8));
  };
  m.error_ = function () {
    this.active_ = !1;
  ...
  var rg = function (a) {
    a.errorDispatched_ ||
      ((a.errorDispatched_ = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'));
  };
  ...
  X.prototype.onReadyStateChange_ = function () {
    if (!this.isDisposed())
      if (this.inOpen_ || this.inSend_ || this.inAbort_) tg(this);
  ...
  var tg = function (a) {
    if (a.active_ && typeof Da != 'undefined')
      if (a.inSend_ && ug(a) == 4) setTimeout(a.onReadyStateChange_.bind(a), 0);
      else if ((a.dispatchEvent('readystatechange'), ug(a) == 4)) {
        a.active_ = !1;
        try {
          try {
          ...
          d ? (a.dispatchEvent('complete'), a.dispatchEvent('success')) : rg(a);
        } finally {
          sg(a);
        }
      }
  ...
  var vg = function (a, b) {
    ...
    sg = function (a, b) {
      if (a.xhr_) {
        a.timeoutId_ && (clearTimeout(a.timeoutId_), (a.timeoutId_ = null));
        var c = a.xhr_;
        a.xhr_ = null;
  ...
  X.prototype.getAllResponseHeaders = function () {
    return this.xhr_ && ug(this) >= 2 ? this.xhr_.getAllResponseHeaders() || '' : '';
  };
  var xg = x(['']),
    yg = x(['https://www.google.com/tools/feedback/help_panel_binary.js']);
  ...
  function Ag(a, b, c, d) {
    var e = a.helpCenterPath.startsWith('/') ? a.helpCenterPath.substring(1) : a.helpCenterPath,
      f = Ye(b),
      g = a.helpPanelMode || 0,
      h = a.fixedHelpPanelContainer,
      k = a.customHelpPanelContainer;
    h && g !== 1 ? (h = void 0) : g !== 1 || (h && !N(f, 5)) || ((g = 0), (h = void 0));
    k && g !== 2 ? (g = 2) : g !== 2 || (k && !a.anchor) || ((g = 0), (k = void 0));
    var l = a.minimizeMode;
    g !== 2 || (l && l !== 0) ? g === 1 && (l = 2) : (l = 2);
    var n = a.openingMode;
    if (a.directToGetHelp) n = 2;
    else if (a.supportContentUrl || a.defaultHelpArticleId) n = 3;
    var q = c.document,
      r = a.nonce,
      p = L(f, We, 10) ? Ze(L(f, We, 10)) || S(xg) : S(yg),
      v = A('document.location.href', c);
    a.helpCenterContext || a.context || !v || (a.context = v.substring(0, 1200));
    v = !0;
    if (d) {
      var D = JSON.stringify(d);
      (v = D.length <= 1200) && (a.psdJson = D);
    }
    v || (d = { invalidPsd: !0 });
    ...
    v.onload = function () {
      c.startHelpPanel({
        ...
        directToGetHelp: a.directToGetHelp || !1,
        ...
        helpPanelTheme: O,
        locale: a.locale,
        nd4cSettingsIsEnabled: a.nd4cSettingsIsEnabled || !1,
  ...
  for (
    ...
    var Fg = Eg.value;
    Cg[Fg] = Fg;
    for (var Gg = w(Bg[Fg]), Hg = Gg.next(); !Hg.done; Hg = Gg.next()) Cg[Hg.value] = Fg;
  }
  var Ig = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  };
  ...
  function bh() {
      ...
      for (p = 0; p < 80; p++) {
        if (p < 40)
          if (p < 20) {
            var ma = O ^ (v & (D ^ O));
            var Ha = 1518500249;
          } else ((ma = v ^ D ^ O), (Ha = 1859775393));
        else
          p < 60
            ? ((ma = (v & D) | (O & (v | D))), (Ha = 2400959708))
            : ((ma = v ^ D ^ O), (Ha = 3395469782));
    ...
    function c(q, r) {
      if (typeof q === 'string') {
        ...
        for (var p = [], v = 0, D = q.length; v < D; ++v) p.push(q.charCodeAt(v));
        q = p;
      }
      r || (r = q.length);
      p = 0;
      if (l == 0) for (; p + 64 < r; ) (b(q.slice(p, p + 64)), (p += 64), (n += 64));
      for (; p < r; )
        if (((f[l++] = q[p++]), n++, l == 64))
    ...
    function d() {
      ...
      for (var p = 63; p >= 56; p--) ((f[p] = r & 255), (r >>>= 8));
      b(f);
      for (p = r = 0; p < 5; p++) for (var v = 24; v >= 0; v -= 8) q[r++] = (e[p] >> v) & 255;
      return q;
    }
    ...
    return {
      ...
      digestString: function () {
        for (var q = d(), r = '', p = 0; p < q.length; p++)
          r +=
            '0123456789ABCDEF'.charAt(Math.floor(q[p] / 16)) + '0123456789ABCDEF'.charAt(q[p] % 16);
        return r;
      },
    };
  }
  var dh = function (a, b, c) {
      ...
      return d && a && b ? [b, ch(ah(d), a, c || null)].join(' ') : null;
    },
    ch = function (a, b, c) {
      var d = [],
        e = [];
  ...
  var fh = function () {
    this.document_ = document || { cookie: '' };
  };
  m = fh.prototype;
  ...
  m.get = function (a, b) {
    for (
      var c = a + '=', d = (this.document_.cookie || '').split(';'), e = 0, f;
      e < d.length;
      e++
    ) {
      f = Za(d[e]);
  ...
  m.clear = function () {
    for (var a = gh(this).keys, b = a.length - 1; b >= 0; b--) this.remove(a[b]);
  };
  var gh = function (a) {
  ...
  var hh = function (a, b, c, d) {
    (a = z[a]) || typeof document === 'undefined' || (a = new fh().get(b));
    return a ? dh(a, c, d) : null;
  };
  function ih(a) {
    Ob(a);
    Ub(a);
  ...
  var nh = [
    ...
    /https:\/\/feedback-frontend-qual[a-z0-9.]*\.google\.com\/inapp/,
    /https:\/\/feedback-frontend-qual[a-z0-9.]*\.google\.com\/tools\/feedback/,
  ...
  var ph = x(['https://www.gstatic.com/uservoice/feedback/client/web/', '/main_light_binary.js']),
    qh = x(['https://www.gstatic.com/uservoice/feedback/client/web/', '/main_binary__', '.js']);
  function rh(a, b) {
    var c;
    var d = (c = a.formContent) == null ? void 0 : c.locale;
    c = d == null ? void 0 : d.split('-')[0];
    d = d && oh.includes(d) ? d : c && oh.includes(c) ? c : void 0;
    d = (d != null ? d : 'en').replaceAll('-', '_').toLowerCase();
    var e;
    a = ((e = a.initializationData) == null ? 0 : e.useNightlyRelease) ? 'nightly' : 'live';
    var f;
    return (b == null ? 0 : (f = b.getEnableAlohaBinarySplit) == null ? 0 : f.call(b))
      ? S(ph, a)
      : S(qh, a, d);
  }
  var sh = function () {
  ...
  var th, uh, vh, wh;
  function xh(a, b, c, d) {
    if (th && vh === b) return th;
    vh = b;
    var e = rh(a, d);
    return (th = b.feedbackV2GlobalObject
      ? Promise.resolve(b.feedbackV2GlobalObject)
      : new Promise(function (f, g) {
          var h = Cd(document, 'SCRIPT');
          ud(h, e);
          h.onload = function () {
            b.feedbackV2GlobalObject
  ...
  function yh(a, b, c, d) {
    if (uh && wh === b) return uh;
    wh = b;
    var e = rh(a, d);
    return (uh = b.feedbackV2GlobalObject
      ? Promise.resolve(b.feedbackV2GlobalObject)
      : new Promise(function (f, g) {
          var h = Cd(document, 'SCRIPT');
          ud(h, e);
  ...
  function zh(a, b, c, d, e) {
    ...
    return ya(function (n) {
      switch (n.nextAddress) {
        case 1:
          return ((f = Date.now()), ra(n, xh(a, c, d, b), 2));
        case 2:
          g = n.yieldResult;
          if (
            !(
              e ||
              ((k = a.initializationData) == null ? 0 : k.useNightlyRelease) ||
              ((l = a.initializationData) == null ? 0 : l.isLocalServer)
            )
          ) {
        ...
        case 4:
          h = n.yieldResult;
        case 3:
          return (h.initiateAloha(), n.return(h));
      }
    });
  }
  function Ah(a, b, c, d) {
    ...
    return ya(function (h) {
      if (h.nextAddress == 1) return ((e = Date.now()), ra(h, yh(a, c, d.document, b), 2));
      if (h.nextAddress != 3)
        return ((f = h.yieldResult), ra(h, f.initializeFeedbackClientAsync(a, e, b, d), 3));
      g = h.yieldResult;
      g.initiateAloha();
      return h.return(g);
    });
  ...
  function Bh(a, b, c) {
    ...
    return ya(function (r) {
      ...
      if ((f = b) == null ? 0 : (h = (g = f).getEnableAlohaBinarySplit) == null ? 0 : h.call(g)) {
        k = e;
        if (k.isFormOpened) throw new sh();
        k.isFormOpened = !0;
        ...
        try {
          ...
          throw ((k.isFormOpened = !1), p);
        }
      } else {
        n = e;
        if (n.isFormOpened) throw new sh();
        n.isFormOpened = !0;
        a.callbacks = a.callbacks || {};
    ...
    return ya(function (c) {
      return c.return(
        new Promise(function (d, e) {
          Number.isInteger(Number(a)) && Number(a) > 0
            ? ((e = Dh(b != null ? b : '') + '/aloha_form_properties?productId=' + a),
              qg(
                e,
                function (f) {
                  f = f.target;
  ...
  function Dh(a) {
    return mh(a) ? a : 'https://www.google.com/tools/feedback';
  }
  var Eh = function (a, b, c) {
      a.timeOfStartCall = new Date().getTime();
      var d = c || z,
        e = d.document,
        f = a.nonce || td(d.document);
      f && !a.nonce && (a.nonce = f);
      if (a.flow == 'help') {
      ...
      if ((g = d.GOOGLE_FEEDBACK_START)) g.apply(d, b);
        ...
        for (var k in a)
          ((b = a[k]),
            b == null || Ia(b) || (d += encodeURIComponent(k) + '=' + encodeURIComponent(b) + '&'));
    ...
    Gh = function (a, b, c) {
      try {
        if (a.flow === 'help') {
          ...
          a.flow === 'submit'
            ? Eh(a, b, c)
            : Ch(a.productId, a.feedbackServerUri).then(
                function (e) {
                  e = L(e, jh, 1);
                  var f = !jb || (e == null ? void 0 : e.getEnableMweb()),
                    g = !a.tinyNoPointer || (e == null ? void 0 : e.getEnableTinyNoPointer());
                  !e || (e.getAlohaAutoGaRollout() && f && g)
                    ? Fh(a, b, c, e).catch(function (h) {
                        !h || h instanceof sh || Eh(a, b, c);
                      })
                    : Eh(a, b, c);
                },
                function (e) {
                  !e || e instanceof sh || Eh(a, b, c);
                }
              );
      } catch (e) {
        Fh(a, b, c, null).catch(function (f) {
          !f || f instanceof sh || Eh(a, b, c);
        });
      }
    };
  ...
  function Hh(a, b) {
    var c = ld(a);
    if (!Ih.test(c)) throw Error('Invalid TrustedResourceUrl format: ' + c);
    a = c.replace(Jh, function (d, e) {
      ...
      d = b[e];
      return d instanceof kd ? ld(d) : encodeURIComponent(String(d));
    });
    return Sa(a);
  }
  var Jh = /%{(\w+)}/g,
  ...
  var Lh = { done: !0, value: void 0 };
  Kh.prototype.__iterator__ = function () {
    return this;
  };
  var Mh = function (a) {
    if (a instanceof Kh) return a;
    if (typeof a.__iterator__ == 'function') return a.__iterator__(!1);
    if (Ga(a)) {
      var b = 0,
        c = new Kh();
      c.next = function () {
        for (;;) {
          if (b >= a.length) return Lh;
  ...
  function Nh(a) {
    this.elements_ = {};
    if (a) for (var b = 0; b < a.length; b++) this.elements_[Oh(a[b])] = null;
    for (var c in Object.prototype);
  }
  var Ph = {},
    Oh = function (a) {
      return a in Ph || String(a).charCodeAt(0) == 32 ? ' ' + a : a;
    },
    Qh = function (a) {
      return a.charCodeAt(0) == 32 ? a.slice(1) : a;
    };
  m = Nh.prototype;
  m.add = function (a) {
  ...
  m.clone = function () {
    var a = new Nh(),
      b;
    for (b in this.elements_) a.elements_[b] = null;
    return a;
  };
  ...
  m.forEach = function (a, b) {
    for (var c in this.elements_) a.call(b, Qh(c), void 0, this);
  };
  m.values = Object.keys
    ? function () {
    ...
    : function () {
        var a = [],
          b;
        for (b in this.elements_) a.push(Qh(b));
        return a;
      };
  m.getValues = function () {
    return this.values();
  ...
  m.isEmpty = function () {
    for (var a in this.elements_) return !1;
    return !0;
  };
  m.isSubsetOf = function (a) {
    for (var b in this.elements_) if (!(b in a.elements_)) return !1;
    return !0;
  };
  ...
  m.delete = function (a) {
    a = Oh(a);
    return a in this.elements_ ? (delete this.elements_[a], !0) : !1;
  };
  m.remove = function (a) {
  ...
  var Rh = function (a) {
      if (a.getValues && typeof a.getValues == 'function') return a.getValues();
      if (
    ...
    Sh = function (a) {
      if (a.getKeys && typeof a.getKeys == 'function') return a.getKeys();
    ...
    Th = function (a, b, c) {
      ...
      else if (Ga(a) || typeof a === 'string') Array.prototype.forEach.call(a, b, c);
      else
    ...
    if (a instanceof Uh) {
      ...
      a && (b = String(a).match(lg))
        ? ((this.ignoreCase_ = !1),
          ...
          Y(this),
          (this.fragment_ = Yh(a)))
        : ((this.ignoreCase_ = !1), (this.queryData_ = new Zh(null, this.ignoreCase_)));
  };
  Uh.prototype.toString = function () {
    ...
    if (c || b == 'file')
      (a.push('//'),
        (b = this.userInfo_) && a.push($h(b, ai, !0), '@'),
        a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, '%$1')),
        (c = this.port_),
        c != null && a.push(':', String(c)));
    if ((c = this.path_))
      (this.domain_ && c.charAt(0) != '/' && a.push('/'),
        a.push($h(c, c.charAt(0) == '/' ? bi : ci, !0)));
    (c = this.queryData_.toString()) && a.push('?', c);
    (c = this.fragment_) && a.push('#', $h(c, di));
    return a.join('');
  };
  Uh.prototype.resolve = function (a) {
    var b = this.clone(),
      c = !!a.scheme_;
    c ? Vh(b, a.scheme_) : (c = !!a.userInfo_);
    if (c) {
      var d = a.userInfo_;
      Y(b);
      b.userInfo_ = d;
    } else c = !!a.domain_;
    c ? ((d = a.domain_), Y(b), (b.domain_ = d)) : (c = a.port_ != null);
    d = a.path_;
    if (c) Wh(b, a.port_);
    else if ((c = !!a.path_)) {
      if (d.charAt(0) != '/')
    ...
    c ? (Y(b), (b.path_ = d)) : (c = a.queryData_.toString() !== '');
    c ? Xh(b, a.queryData_.clone()) : (c = !!a.fragment_);
    c && ((a = a.fragment_), Y(b), (b.fragment_ = a));
    return b;
  };
  ...
  var Vh = function (a, b, c) {
    ...
    Xh = function (a, b, c) {
      ...
      b instanceof Zh
        ...
        : (c || (b = $h(b, ei)), (a.queryData_ = new Zh(b, a.ignoreCase_)));
    };
  ...
  m.getKeys = function () {
    gi(this);
    for (
      var a = Array.from(this.keyMap_.values()), b = Array.from(this.keyMap_.keys()), c = [], d = 0;
      d < b.length;
      d++
    )
  ...
  m.getValues = function (a) {
    gi(this);
    var b = [];
    if (typeof a === 'string') this.containsKey(a) && (b = b.concat(this.keyMap_.get(hi(this, a))));
    else {
  ...
  new Nh(
    'head HEAD link LINK style STYLE meta META defs DEFS script SCRIPT html HTML base BASE colgroup COLGROUP col COL wbr WBR content CONTENT slot SLOT'.split(
      ' '
    )
  );
  ...
  function ii(a, b) {
    a = new Uh(a);
    return b === void 0 || b
      ? Vh(a, a.scheme_ || location.protocol).toString()
      : Vh(a, 'http').toString();
  }
  var ji = x(['https://feedback.googleusercontent.com/resources/annotator.css']),
    ki = x(['https://feedback.googleusercontent.com/resources/render_frame2.html']);
  S(ji);
  S(ki);
  var li = function (a) {
    var b = a || {};
    a = b.serverUri;
    var c = a + '/%{resource}',
      d = { resource: R('chat_load.js') };
    b = b.https;
    var e = [
      R('//www.google.com/tools/feedback/%{resource}'),
      R('https://www.google.com/tools/feedback/%{resource}'),
      R('https://support.google.com/inapp/%{resource}'),
      R('https://sandbox.google.com/inapp/%{resource}'),
      R('https://feedback2-test.corp.google.com/inapp/%{resource}'),
      R('https://feedback2-test.corp.googleusercontent.com/inapp/%{resource}'),
      R('https://sandbox.google.com/tools/feedback/%{resource}'),
      R('https://feedback2-test.corp.google.com/tools/feedback/%{resource}'),
      R('https://feedback2-test.corp.googleusercontent.com/tools/feedback/%{resource}'),
      R('https://www.google.cn/tools/feedback/%{resource}'),
    ].filter(function (f) {
      return ld(f) == c;
    })[0];
    if (e) return Hh(e, d);
  ...
  var ni = x([
      ...
      '/js/survey/survey_binary__',
      '.js',
    ]),
    oi = x(['https://gstatic.com/uservoice/surveys/resources/', '/js/survey/survey_', '_', '.css']),
    pi = Date.now(),
    qi = /uservoice\/surveys\/resources\/(non)?prod\/js\/survey\/survey_(dark|light)_(ltr|rtl)/gi,
    ri = /uservoice\/surveys\/resources\/(non)?prod\/js\/survey\/survey_binary__/gi,
    Z = function (a, b) {
      this.productId_ = a;
      ...
      a: {
        ...
        c = (c = b.frdProductData || b.frdProductData) ? si(c) : void 0;
      }
      this.frdProductDataBase64EncodedString_ = c;
      this.helpCenterPath_ = b.helpCenterPath || b.helpCenterPath || '';
      this.helpcenter = this.helpCenterPath_.startsWith('/')
        ? this.helpCenterPath_.substring(1)
        : this.helpCenterPath_;
      this.apiKey_ = b.apiKey || b.apiKey || '';
      this.renderApiUri_ = b.renderApiUri || b.renderApiUri || '';
      this.asxUiUri_ = b.asxUiUri || b.asxUiUri || '';
      var d;
      (b = b.nonce || b.nonce) ||
        ((b = (d = this.window_) == null ? void 0 : d.document), (b = td(b)));
      this.nonce_ = b;
      this.surveyStartupConfig_ = Yg(new Xg(), Tg(!1));
      this.thirdPartyDomainSupportEnabled_ = !1;
    };
  m = Z.prototype;
  ...
  m.updateContext = function (a) {
    var b = A('gapi.rpc');
    b &&
      document.getElementById('help_panel_main_frame') !== null &&
      (a || (a = A('document.location.href', window).substring(0, 1200)),
      b.setup(''),
  ...
  m.startHelp = function (a) {
    var b = this,
      c = document.getElementById('help_panel_main_frame');
    if (c && c.style.visibility === 'hidden') {
      if (((c.style.visibility = 'visible'), a.onRestoreCallback)) a.onRestoreCallback();
    } else {
      c = new Date().getTime();
      var d = a ? ui(this, a, c) : {};
      a = d.openingMode || 0;
      try {
        zg(
          this.receiverUri_ || 'https://www.google.com/tools/feedback',
          this.locale_,
          d.helpCenterContext,
          this.productId_,
          this.helpcenter,
          ...
          if (f) {
            ...
            f.style.width = g != null ? g : '360px';
            f.replaceChildren();
          } else Dd(document.getElementById('help_panel_main_frame'));
  ...
  m.startHelpCard = function (a, b) {
    ...
    try {
      zg(
        ...
        var g;
        (g = document.getElementById('help_card_main_frame')) == null || g.remove();
        bf(e, JSON.stringify(Gc(f)), c.window_, b || void 0);
      });
    } catch (f) {
      sd(window, 'https://support.google.com/' + this.helpcenter);
    }
  ...
  var ti = function (a, b) {
    ...
    ui = function (a, b, c) {
      ...
      var e,
        ...
        p = d.context,
        v = a.helpCenterPath_,
        D = d.helpFlowSessionId,
        O = d.enableSendFeedback || !1,
        rb = d.defaultHelpArticleId,
        ma = d.supportContentUrl,
        Ha = d.helpPanelTheme,
        Bi = d.nd4cSettings ? d.nd4cSettings.isEnabled : !1,
        Ci = d.nd4cSettings ? d.nd4cSettings.countryCode : '',
        Di = d.userIp ? d.userIp : '',
        Ei = d.defaultHelpArticleFragment,
        Fi = d.suggestHost,
        Gi = a.renderApiUri_,
        Hi = d.symptom,
        Ii = d.timezone,
        Ji = d.directToGetHelp || !1,
        Ki = (e = d.helpGuideOptions) == null ? void 0 : e.openToHelpGuideEntryButtonId;
      e = (f = d.helpGuideOptions) == null ? void 0 : f.enableHelpGuideMaximize;
      f =
        ((g = d.helpGuideOptions) == null ? void 0 : g.enableHelpGuideConversationalAi) === !1
          ? !1
          : !0;
      g = (h = d.helpGuideOptions) == null ? void 0 : h.enableHelpGuideHumanChat;
      h = a.window_.location.protocol + '//' + a.window_.location.host;
      var Li = d.helpPanelMode,
        Mi = d.fixedHelpPanelContainer,
        Ni = d.customHelpPanelContainer,
        Oi = a.frdProductDataBase64EncodedString_,
        Pi = d.onCloseCallback,
        Qi = d.onMinimizeCallback,
        Ri = d.onLoadCallback,
        Si = d.onPromotedProductLinkClickCallback,
        Ti = d.onGseEventCallback,
        Ui = d.openingMode,
        Vi = d.minimizeMode,
        Wi = ((k = d.helpGuideOptions) == null ? 0 : k.helpGuideHelpCenterEmbedEntryPoint)
          ? si(d.helpGuideOptions.helpGuideHelpCenterEmbedEntryPoint)
          : void 0;
      k = ((l = d.helpGuideOptions) == null ? 0 : l.helpGuideCommonEmbedEntryPoint)
        ? si(d.helpGuideOptions.helpGuideCommonEmbedEntryPoint)
        : void 0;
      a: {
        var Kf;
        ...
        var Lf;
        Ed = ((Lf = d.helpGuideOptions) == null ? 0 : Lf.helpGuideStartingFlow)
          ? si(d.helpGuideOptions.helpGuideStartingFlow)
          : void 0;
      }
      a: {
        var Mf;
        ...
        var Nf;
        Fd = ((Nf = d.helpGuideOptions) == null ? 0 : Nf.gseSessionOptions)
          ? si(d.helpGuideOptions.gseSessionOptions)
          : void 0;
      }
      a = {
        anchor: q,
        ...
        gsePageUrl: (n = d.helpGuideOptions) == null ? void 0 : n.pageUrl,
      };
      hd(b, a);
      return b;
    };
  ...
  m.loadChatSupport = function (a) {
    var b = a || {};
    a = a ? ui(this, a) : {};
    hd(a, { escalationJSONString: b.escalationJSONString });
    mi(a, this.productData_);
  };
  m.requestSurvey = function (a) {
    if (!vi(a.triggerId)) throw Error('Invalid triggerId');
    var b = Date.now();
    wi(this, a, !1).then(
      function (c, d) {
        ...
        if (e) {
          var f = xi(e),
            g;
          d.getSession() && Re(d.getSession()) && (g = Re(d.getSession()));
          var h = {
            surveyData: {
              ...
              surveyMetadata: { triggerId: a.triggerId, sessionId: g, surveyId: d.getSurveyId() },
          ...
          ((h = {
            ...
            surveyError: { reason: 'No eligible surveys.' },
          }),
            c(h));
      }.bind(this, a.callback),
      function (c) {
        var d = '';
        try {
          d = JSON.stringify(c);
        ...
        a.callback({
          surveyData: null,
          triggerId: a.triggerId,
          surveyError: { reason: 'Failed to trigger survey: ' + d },
        });
      }
    );
  };
  m.presentSurvey = function (a) {
    if (a.surveyData) {
      var b =
        a.surveyData && a.surveyData.surveyData && a.surveyData.surveyData.surveyData
      ...
      a: if (((d = a.promptStyle), (e = c.getDisplaySettings().getAllowedPromptStyleList()), d)) {
        switch (d) {
          case 1:
            d = e.includes(1);
            break a;
      ...
      if (d) {
        a: if (
          ((d = a.completionStyle), (c = c.getCompletion().getAllowedCompletionStyleList()), d)
        ) {
          switch (d) {
            case 1:
              c = c.includes(1);
        ...
        if (c)
          if (
            a.parentDomElementId != void 0 &&
            a.parentDomElementId != '' &&
            document.getElementById(a.parentDomElementId) == null
          )
            a.listener &&
              a.listener.surveyPrompted &&
              a.listener.surveyPrompted(a.surveyData, { reason: 'Invalid parent dom element id' });
          else {
            ...
            a: {
              ...
              if (
                ...
                (f = f.defaultView.getComputedStyle(e, null))
              ) {
            ...
            f =
              'rtl' ==
              (f ||
                (e.currentStyle ? e.currentStyle.direction : null) ||
                (e.style && e.style.direction))
                ? 'rtl'
                : 'ltr';
            if (
              a.completionStyle === 2 &&
              !yi(
                'https://gstatic.com/uservoice/surveys/resources/' +
                  c +
                  '/js/survey/survey_' +
                  d +
                  '_' +
              ...
              if (c instanceof Ra) ((e.href = Ta(c).toString()), (e.rel = 'stylesheet'));
                ...
                c = rd(c);
                c !== void 0 && ((e.href = c), (e.rel = 'stylesheet'));
              }
          ...
          a.listener &&
            a.listener.surveyPrompted &&
            a.listener.surveyPrompted(a.surveyData, { reason: 'Invalid completion style' });
      } else
        a.listener &&
          a.listener.surveyPrompted &&
          a.listener.surveyPrompted(a.surveyData, { reason: 'Invalid prompt style' });
    }
  };
  m.dismissSurvey = function (a) {
    window.hatsNextGlobalObject &&
      window.hatsNextGlobalObject.dismissSurvey &&
    ...
    wi(this, a, !0).then(
      function (b) {
        b({
          ...
          triggerId: a.triggerId,
          surveyId: a.surveyIdForTestingMode,
          surveyError: { reason: 'Survey scheduled for later.' },
        });
      }.bind(this, a.callback),
      function (b) {
        var c = '';
        ...
        a.callback({
          surveyData: null,
          triggerId: a.triggerId,
          surveyError: { reason: 'Failed to trigger survey: ' + c },
        });
      }
    );
  };
  ...
  var Zi = function (a, b) {
      if (b.enableFeedback1pEndpoint && b.enableTestingMode)
        return (
          (a.surveyStartupConfig_ = Yg(new Xg(), Tg(!0))),
          Promise.resolve(a.surveyStartupConfig_)
        );
      b = new Be({
        serverUrl: b.nonProd
      ...
      return Zi(a, b).then(
        function (d) {
          if (Sg(L(d, Rg, 1))) {
            ...
            var g = new Jg()
                .setPlatform(1)
                .setLibraryVersionInt(438217234)
                .setSupportedCapabilityList([1, 2]),
              h =
                b.preferredSurveyLanguageList && b.preferredSurveyLanguageList.length > 0
                  ? b.preferredSurveyLanguageList
                  : [a.locale_];
            h = new Ug()
              .setTriggerId(b.triggerId)
              .setLanguageList(h)
              .setTestingMode(!!b.enableTestingMode);
            b.surveyIdForTestingMode != '' &&
              b.surveyIdForTestingMode != void 0 &&
              b.enableTestingMode == 1 &&
              h.setSurveyId(b.surveyIdForTestingMode);
            f = new Zg()
              .setTriggerContext(h)
              .setClientContext(new Kg().setDeviceInfo(f).setLibraryInfo(g));
            c != '' &&
              c != void 0 &&
              c == 1 &&
    ...
    $i = function (a, b) {
      var c = [],
        d = ah(z == null ? void 0 : z.location.href);
      var e = [];
      var f;
      (f = z.__SAPISID || z.__APISID || z.__3PSAPISID || z.__1PSAPISID || z.__OVERRIDE_SID)
        ? (f = !0)
      ...
      f &&
        ((f = (d =
          d.indexOf('https:') == 0 ||
          d.indexOf('chrome-extension:') == 0 ||
          d.indexOf('chrome-untrusted://new-tab-page') == 0 ||
          d.indexOf('moz-extension:') == 0)
          ? z.__SAPISID
          : z.__APISID),
        f ||
          typeof document === 'undefined' ||
          ((f = new fh()), (f = f.get(d ? 'SAPISID' : 'APISID') || f.get('__Secure-3PAPISID'))),
        (f = f ? dh(f, d ? 'SAPISIDHASH' : 'APISIDHASH', c) : null) && e.push(f),
        d &&
          ((d = hh('__1PSAPISID', '__Secure-1PAPISID', 'SAPISID1PHASH', c)) && e.push(d),
          (c = hh('__3PSAPISID', '__Secure-3PAPISID', 'SAPISID3PHASH', c)) && e.push(c)));
      e = e.length == 0 ? null : e.join(' ');
      b.thirdPartyDomainSupportEnabled != void 0 &&
        b.thirdPartyDomainSupportEnabled &&
        ((a.thirdPartyDomainSupportEnabled_ = !0), (e = !1));
      return e ? 'v1/survey/trigger' : 'v1/survey/trigger/trigger_anonymous';
    },
    aj = function (a, b, c) {
      var d = new Be({
          serverUrl: b.nonProd
      ...
      b = new Te()
        .setTriggerContext(a)
        .setClientContext(new Ke().setDeviceInfo(f).setLibraryInfo(g));
      c != '' &&
        c != void 0 &&
        c == 1 &&
    ...
    xi = function (a) {
      try {
        var b = parseInt,
          c = a.getDisplaySettings().getPromptDelay();
        var d = L(c, W, 1);
    ...
    Ai = function (a, b, c) {
      var d = c.nonProd ? 'nonprod' : 'prod',
        e =
          c.language && Cg[c.language.toLowerCase()]
            ? Cg[c.language.toLowerCase()]
            : Cg[a.locale_.toLowerCase()];
      e = e && e.replace('-', '_');
      e === 'fa' && (e = 'en');
      var f = e ? encodeURI(e) : 'en';
      b.enableReloadScriptWhenLanguageChanges &&
        !bj(
          'https://www.gstatic.com/uservoice/surveys/resources/' +
            d +
            '/js/survey/survey_binary__' +
      ...
      window.hatsNextGlobalObject
        ...
        : ((e = document.createElement('script')),
          ...
          (e.onerror = function () {
            b.listener &&
              b.listener.surveyPrompted &&
              b.listener.surveyPrompted(c, { reason: 'Failed to load survey binary' });
          }),
          e.setAttribute('data-survey-binary', ''),
          a.nonce_ && e.setAttribute('nonce', a.nonce_),
          document.querySelector('[data-survey-binary]') || document.body.appendChild(e));
    },
    dj = function (a, b) {
      a: {
        var c = 'triggerCutoffTime';
        a.parentDomElementId != null &&
          a.parentDomElementId != '' &&
          ...
          if (window.hatsNextGlobalObject[c] > b.triggerRequestTime) {
            a.listener &&
              ...
              a.listener.surveyPrompted(b, {
                reason:
                  'Survey was triggered before the most recent survey event. Please re-trigger the survey.',
              });
            c = !1;
            break a;
          }
        ...
        c > 864e5
          ? (a.listener &&
              ...
              a.listener.surveyPrompted(b, {
                reason:
                  'Survey must be triggered within the last 24 hours. Survey was triggered ' +
                  (c + ' ms ago.'),
              }),
            (c = !1))
          : (c = !0);
      ...
      if (c) {
        ...
        window.hatsNextGlobalObject.initSurvey({
          ...
          promptStyle: (d = a.promptStyle) != null ? d : 1,
          completionStyle: (e = a.completionStyle) != null ? e : 1,
          defaultStyle: (f = a.defaultStyle) != null ? f : 0,
    ...
    Yi = function () {
      ...
      a || ((a = new Ve()), Ea('help.globals.actions', a, top));
      return a;
    },
    bj = function (a) {
    ...
    cj = function () {
      [].concat(la(document.getElementsByTagName('script'))).forEach(function (a) {
        ...
        if (a == null ? 0 : (b = a.getAttribute('src')) == null ? 0 : b.match(ri))
          (a.parentNode.removeChild(a), (window.hatsNextGlobalObject = null));
      });
    },
    zi = function () {
      document.querySelectorAll('link[rel=stylesheet]').forEach(function (a) {
        var b;
        (a == null ? 0 : (b = a.getAttribute('href')) == null ? 0 : b.match(qi)) &&
    ...
    si = function (a) {
      ...
      try {
        ...
        return (console.log('Failed to serialize and encode proto: ', b), '');
      }
    },
    yi = function (a) {
