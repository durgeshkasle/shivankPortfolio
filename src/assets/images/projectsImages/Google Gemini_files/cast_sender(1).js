    ...
    da = function (a, b) {
      if (b)
        a: {
          ...
          d = c[a];
          b = b(d);
          b != d && b != null && g(c, a, { configurable: !0, writable: !0, value: b });
        }
    };
...
*/
  var r = this || self,
    ...
    x = function (a, b) {
      a = a.split('.');
      for (var c = r, d; a.length && (d = a.shift()); )
        a.length || b === void 0
  ...
  chrome.cast.ja = { CREATE_SESSION: 'create_session', CAST_THIS_TAB: 'cast_this_tab' };
  ...
  chrome.cast.N = { AVAILABLE: 'available', UNAVAILABLE: 'unavailable' };
  x('chrome.cast.ReceiverAvailability', chrome.cast.N);
  chrome.cast.ob = { CHROME: 'chrome', IOS: 'ios', ANDROID: 'android' };
  x('chrome.cast.SenderPlatform', chrome.cast.ob);
  chrome.cast.xa = { CAST: 'cast', DIAL: 'dial', HANGOUT: 'hangout', CUSTOM: 'custom' };
  ...
  chrome.cast.jb = { CAST: 'cast', STOP: 'stop' };
  x('chrome.cast.ReceiverAction', chrome.cast.jb);
  chrome.cast.K = { CONNECTED: 'connected', DISCONNECTED: 'disconnected', STOPPED: 'stopped' };
  x('chrome.cast.SessionStatus', chrome.cast.K);
  chrome.cast.Db = { ATTENUATION: 'attenuation', FIXED: 'fixed', MASTER: 'master' };
...
*/
  ...
  function ya() {
    ...
    try {
      ...
      a = xa.createPolicy('goog#html', { createHTML: b, createScript: b, createScriptURL: b });
    } catch (c) {
      throw c;
    }
    return a;
  ...
  var Fa = function (a) {
      ...
      return a.replace(Ea, function (d, e) {
        ...
        if (h) return h;
        e.charAt(0) == '#' &&
          ((e = Number('0' + e.slice(1))), isNaN(e) || (h = String.fromCharCode(e)));
        if (!h) {
          h = d + ' ';
          y === void 0 && (y = ya());
  ...
  chrome.cast.ib = function (a, b, c, d) {
    ...
    ua.test(a) &&
      ...
      a.indexOf('\x00') != -1 && (a = a.replace(ta, '&#0;')));
    this.friendlyName = a;
    this.capabilities = c || [];
    this.volume = d || null;
  ...
  chrome.cast.media.Va = { SDR: 'sdr', HDR: 'hdr', DV: 'dv' };
  ...
  chrome.cast.media.Xa = { MPEG2_TS: 'mpeg2_ts', FMP4: 'fmp4' };
  ...
  chrome.cast.media.lb = { PLAYBACK_START: 'PLAYBACK_START', PLAYBACK_PAUSE: 'PLAYBACK_PAUSE' };
  x('chrome.cast.media.ResumeState', chrome.cast.media.lb);
  chrome.cast.media.za = { BUFFERED: 'BUFFERED', LIVE: 'LIVE', OTHER: 'OTHER' };
  ...
  chrome.cast.media.yb = { TEXT: 'TEXT', AUDIO: 'AUDIO', VIDEO: 'VIDEO' };
  ...
  chrome.cast.media.wb = { NONE: 'NONE', NORMAL: 'NORMAL', ROUNDED_CORNERS: 'ROUNDED_CORNERS' };
  ...
  f.Zb = function (a, b, c) {
    C(this, a) < 0 ||
      B.m(this, 'QUEUE_REMOVE', new chrome.cast.media.ua([a]), b, c, chrome.cast.media.timeout.v);
  };
  f.bc = function (a, b, c) {
  ...
  f.Lb = function () {
    if (this.breakStatus && this.breakStatus.currentBreakTime !== void 0)
      return this.playerState == chrome.cast.media.B.PLAYING && this.g >= 0
        ? this.breakStatus.currentBreakTime + (Date.now() - this.g) / 1e3
        : this.breakStatus.currentBreakTime;
  };
  f.Kb = function () {
    if (this.breakStatus && this.breakStatus.currentBreakClipTime !== void 0)
      return this.playerState == chrome.cast.media.B.PLAYING && this.g >= 0
  ...
  f.Mb = function () {
    if (
      ...
      this.liveSeekableRange.start !== void 0 &&
      this.liveSeekableRange.end !== void 0
    ) {
      if (this.playerState == chrome.cast.media.B.PLAYING && this.g >= 0) {
  ...
  D.prototype.next = function () {
    var a = this.g.next();
    return { value: a.done ? void 0 : this.i.call(void 0, a.value), done: a.done };
  };
  var Ka = function (a, b) {
    return new D(a, b);
  };
  ...
  var K = function (a, b) {
    ...
    if (c > 1) {
      ...
      if (a instanceof K) for (c = Na(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  K.prototype.delete = function (a) {
    return M(this.i, a)
      ? (delete this.i[a], --this.size, this.l++, this.g.length > 2 * this.size && L(this), !0)
      : !1;
  };
  var L = function (a) {
  ...
  var Wa = function () {
    ...
    Ya = function (a, b) {
      var c = b.sessionId + '#' + b.mediaSessionId,
        d = a.i[c];
      d ||
        ((d = new chrome.cast.media.h(b.sessionId, b.mediaSessionId)),
        (a.i[c] = d),
      ...
      for (var e in b)
        e != 'items' &&
          b.hasOwnProperty(e) &&
          (e == 'volume'
            ? ((a.volume.level = b.volume.level), (a.volume.muted = b.volume.muted))
            : (a[e] = b[e]));
      ...
      if (a.playerState == chrome.cast.media.B.IDLE && a.loadingItemId == null)
        ((a.currentItemId = null),
          (a.loadingItemId = null),
          (a.preloadedItemId = null),
          (a.items = null));
        ...
        var h = a.items;
        c = {};
        if (h) for (var k = 0; k < h.length; k++) c[h[k].itemId] = k;
        b = ka(b.items);
        for (h = b.next(); !h.done; h = b.next()) {
          ...
          if (!h.media) {
            ...
            m && m.media
              ? (h.media = m.media)
              : k == a.currentItemId && a.media && (h.media = a.media);
          }
          k = e;
          m = k.push;
          var p = void 0,
  ...
  var bb = {},
    ...
    cb =
      (R().indexOf('Gecko') != -1 &&
        !(R().toLowerCase().indexOf('webkit') != -1 && R().indexOf('Edge') == -1) &&
        !(R().indexOf('Trident') != -1 || R().indexOf('MSIE') != -1) &&
        R().indexOf('Edge') == -1) ||
      ab ||
      typeof r.btoa == 'function',
    db = function (a) {
  ...
  var T = function () {
    ...
    U = function (a) {
      ...
      return (b == 'object' && a) || b == 'function'
        ? 'o' + ((Object.prototype.hasOwnProperty.call(a, v) && a[v]) || (a[v] = ++la))
        : b.slice(0, 1) + a;
    };
  f = T.prototype;
  f.add = function (a) {
  ...
  var V = function () {
    ...
    W = function (a, b, c, d) {
      ...
      d !== void 0
        ? (b.sequenceNumber = d)
        : ((b.sequenceNumber = a.i), (a.i = (a.i + 1) % 9007199254740992));
      d = Ra(a.C, b);
      c &&
        d &&
        (a = Qa(a.S, b.sequenceNumber)) &&
        ((a = a.g), (d = new chrome.cast.Error(chrome.cast.A.INVALID_PARAMETER, d)), a && a(d));
    };
  V.prototype.initialize = function (a, b) {
    ...
    a.invisibleSender ||
      ...
      a.reconnect(chrome.cast.Ha).then(
        function (d) {
          Y(c, d);
        },
        function () {}
          ...
          .catch(function (e) {
            ...
            e = new chrome.cast.Error(
              e.name == 'AbortError' || e.name == 'NotAllowedError'
                ? chrome.cast.A.CANCEL
                : chrome.cast.A.SESSION_ERROR
            );
            b && b(e);
          }));
  };
  var X = function (a, b) {
    ...
    var h = [];
    h.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      Ba(a.g.additionalSessionRequests, function (k) {
        h.push({ appId: k.appId, capabilities: k.capabilities });
      });
    return Va(
      new Ua(
        h,
    ...
    a.Da(
      ...
      function (m) {
        m.status && m.status.length == 1
          ? e && e(m.status[0])
          : ((m = new chrome.cast.Error(chrome.cast.A.SESSION_ERROR)), h && h(m));
      },
      h,
      k
    );
  ...
  f.setReceiverVolume = function (a, b, c, d) {
    ...
    W(
      this,
      new P('v2_message', b, void 0, chrome.cast.timeout.setReceiverVolume),
      new O(this.i, c, d, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.getDialAppInfo = function (a, b) {
    W(
      this,
      new P('dial_app_info', void 0, void 0, chrome.cast.timeout.getDialAppInfo),
      new O(this.i, a, b, chrome.cast.timeout.sendCustomMessage)
    );
  };
  f.ca = function (a) {
    var b = this;
    new PresentationRequest(X(this)).reconnect(chrome.cast.cb + a).then(
      function (c) {
        Y(b, c);
      },
      function () {}
  ...
  f.leaveSession = function (a, b, c) {
    W(
      this,
      new P('leave_session', a, void 0, chrome.cast.timeout.leaveSession),
      new O(this.i, b, c, chrome.cast.timeout.leaveSession)
    );
  };
  f.kc = function (a, b, c) {
    W(
      this,
      new P('app_message', a, void 0, chrome.cast.timeout.sendCustomMessage),
      new O(this.i, b, c, chrome.cast.timeout.sendCustomMessage)
    );
  };
  ...
  var gb = function (a, b) {
    if (a.H) {
      ...
      Xa(a.G, c, b) &&
        (a.u.delete(c), a.I.delete(c), (b = a.D.get(c))) &&
        (a.D.delete(c),
        G(b.o(), function (e) {
          e(d);
        }));
  ...
  V.prototype.onMessage = function (a) {
    ...
    if ((b = Qa(this.S, a.sequenceNumber)))
      a.type == 'error' ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    if ((b = a.message))
      switch (a.type) {
