google.maps.__gjsload__('routes', function (_) {
  var CH = function (a, b) {
      return (() => {
        const c = new cra(a, b);
        return () => c;
    ...
    hra = function (a) {
      ...
      if ((b = a[fra]) != null) a = b;
        ...
        if (DH !== DH) throw Error();
        a = a[fra] = gra(a.Dg);
      }
      return a;
    },
    EH = function (a) {
      a[ira] ?? (a[ira] = new Map(era(hra(a)).map((b) => [b.getName(), _.dg(b, 2)])));
    },
    FH = function (a) {
      a[jra] ?? (a[jra] = new Map(era(hra(a)).map((b) => [_.dg(b, 2), b.getName()])));
    },
    kra = class extends _.H {
      constructor(a) {
        super(a, 500);
      }
    },
  ...
  var mra = CH(
    ...
    '[null,[["MANEUVER_UNSPECIFIED",0],["TURN_SLIGHT_LEFT",1],["TURN_SHARP_LEFT",2],["UTURN_LEFT",3],["TURN_LEFT",4],["TURN_SLIGHT_RIGHT",5],["TURN_SHARP_RIGHT",6],["UTURN_RIGHT",7],["TURN_RIGHT",8],["STRAIGHT",9],["RAMP_LEFT",10],["RAMP_RIGHT",11],["MERGE",12],["FORK_LEFT",13],["FORK_RIGHT",14],["FERRY",15],["FERRY_TRAIN",16],["ROUNDABOUT_LEFT",17],["ROUNDABOUT_RIGHT",18],["DEPART",19],["NAME_CHANGE",20]]]'
  );
  var nra = CH(
    'google.maps.routing.v2.TransitVehicle.TransitVehicleType',
    '[null,[["TRANSIT_VEHICLE_TYPE_UNSPECIFIED",0],["BUS",1],["CABLE_CAR",2],["COMMUTER_TRAIN",3],["FERRY",4],["FUNICULAR",5],["GONDOLA_LIFT",6],["HEAVY_RAIL",7],["HIGH_SPEED_TRAIN",8],["INTERCITY_BUS",9],["LONG_DISTANCE_TRAIN",10],["METRO_RAIL",11],["MONORAIL",12],["OTHER",13],["RAIL",14],["SHARE_TAXI",15],["SUBWAY",16],["TRAM",17],["TROLLEYBUS",18]]]'
  );
  var ora = class extends _.H {
    constructor(a) {
      super(a, 500);
    }
  };
  var dra = class extends _.H {
    constructor(a) {
      super(a);
    }
    getName() {
  ...
  var gra = _.ei(
    class extends _.H {
      ...
      setValue(a, b) {
        return _.uf(this, 2, dra, a, b);
      }
      setOptions(a) {
        return _.$f(this, ora, 3, a);
      }
      Dg() {
        return _.gg(this, 6);
      }
      vk(a) {
        return _.yg(this, 6, a);
      }
    }
  );
  var fra = Symbol();
  ...
  var GH = {
    ...
    TravelMode: _.yr,
    VehicleType: _.Nt,
    ComputeRouteMatrixExtraComputation: null,
    ComputeRoutesExtraComputation: null,
    FallbackInfo: null,
    FallbackReason: null,
    FallbackRoutingMode: null,
    GeocodedWaypoint: null,
    GeocodingResults: null,
    MultiModalSegment: null,
    PolylineDetailInfo: null,
    PolylineDetails: null,
    PolylineQuality: null,
    ReferenceRoute: null,
    RoadFeatureState: null,
    Route: null,
    RouteLabel: null,
    RouteLeg: null,
    RouteLegLocalizedValues: null,
    RouteLegStep: null,
    RouteLegStepLocalizedValues: null,
    RouteLegTravelAdvisory: null,
    RouteLocalizedValues: null,
    DirectionalLocation: null,
    RouteMatrix: null,
    RouteMatrixItem: null,
    RouteMatrixItemCondition: null,
    RouteMatrixItemError: null,
    RouteMatrixItemLocalizedValues: null,
    RouteMatrixRow: null,
    RouteTravelAdvisory: null,
  ...
  _.Ml(GH, ['connectForExplicitThirdPartyLoad']);
  _.Ll(GH);
  _.Uk('routes', GH);
});
