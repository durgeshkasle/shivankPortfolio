...
*/
  ...
  var l = function () {
    ...
    r = function (a, b) {
      ...
      a.h = function (c, g, k) {
        for (var f = Array(arguments.length - 2), d = 2; d < arguments.length; d++)
          f[d - 2] = arguments[d];
  ...
  var B = function () {
    ...
    E = function (a, b, e) {
      ...
      if (
        ...
        (!c ||
          (!(c instanceof f.HTMLScriptElement) &&
            (c instanceof f.Location || c instanceof f.Element)))
      ) {
        f = typeof c;
        if (('object' == f && null != c) || 'function' == f)
          try {
            var d =
      ...
      a instanceof A && a.constructor === A
        ? (d = a.g)
        : ((d = typeof a),
          w(
            "expected object of type TrustedResourceUrl, got '" +
              a +
              "' of type " +
              ('object' != d ? d : a ? (Array.isArray(a) ? 'array' : d) : 'null')
          ),
          (d = 'type_error:TrustedResourceUrl'));
      c.src = d;
      (d = c.ownerDocument && c.ownerDocument.defaultView) && d != m
        ? (d = q(d.document))
        : (null === p && (p = q(m.document)), (d = p));
  ...
  if (
    ...
    if (h instanceof Array) Q = h;
      ...
      var R,
        S = 'undefined' != typeof Symbol && Symbol.iterator && h[Symbol.iterator];
      R = S ? S.call(h) : { next: l() };
