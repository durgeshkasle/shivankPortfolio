(function () {
  ...
  function r(a, b) {
    if (b)
      a: {
        ...
        d = c[a];
        b = b(d);
        b != d && b != null && p(c, a, { configurable: !0, writable: !0, value: b });
      }
  }
  r('Symbol', function (a) {
    function b(g) {
    ...
    function c(g, f) {
      this.g = g;
      p(this, 'description', { configurable: !0, writable: !0, value: f });
    }
    if (a) return a;
  ...
  function ma(a) {
    this.next = function (b) {
      z(a.g);
      a.g.h ? (b = D(a, a.g.h.next, b, a.g.o)) : (a.g.o(b), (b = E(a)));
      return b;
    };
    this.throw = function (b) {
      z(a.g);
      a.g.h ? (b = D(a, a.g.h['throw'], b, a.g.o)) : (B(a.g, b), (b = E(a)));
      return b;
    };
  ...
  r('Promise', function (a) {
    ...
    b.prototype.j = function () {
      ...
      var e = this,
        h = !1;
      return { resolve: f(this.K), reject: f(this.l) };
    };
    ...
    b.prototype.A = function (f, e) {
      if (this.h != 0)
        throw Error(
          'Cannot settle(' + f + ', ' + e + '): Promise already settled in state' + this.h
        );
      this.h = f;
      this.i = e;
      this.h === 2 && this.L();
    ...
    b.prototype.I = function () {
      ...
      typeof f === 'function'
        ...
        : typeof e === 'function'
          ? (f = new e('unhandledrejection', { cancelable: !0 }))
    ...
    b.race = function (f) {
      return new b(function (e, h) {
        for (var l = x(f), m = l.next(); !m.done; m = l.next()) d(m.value).B(e, h);
      });
    };
    b.all = function (f) {
      var e = x(f),
      ...
      return h.done
        ...
        : new b(function (l, m) {
            ...
            var w = [],
              A = 0;
            do (w.push(void 0), A++, d(h.value).B(u(w.length - 1), m), (h = e.next()));
            while (!h.done);
          });
    };
    return b;
    ...
    typeof Object.assign == 'function'
      ...
      : function (a, b) {
          ...
          for (var c = 1; c < arguments.length; c++) {
            var d = arguments[c];
            if (d) for (var k in d) G(d, k) && (a[k] = d[k]);
          }
          return a;
        };
  ...
  r('WeakMap', function (a) {
    ...
    b.prototype.set = function (h, l) {
      ...
      k(h);
      if (!G(h, f)) throw Error('WeakMap key fail: ' + h);
      h[f][this.g] = l;
      return this;
    };
  ...
  r('Map', function (a) {
      ...
      if (m && G(e[0], l))
        for (e = 0; e < m.length; e++) {
          ...
          if ((h !== h && u.key !== u.key) || h === u.key)
            return { id: l, list: m, index: e, entry: u };
        }
    ...
    function k(e) {
      ...
      if (e) {
        e = x(e);
        for (var h; !(h = e.next()).done; ) ((h = h.value), this.set(h[0], h[1]));
      }
    }
    if (
      (function () {
    ...
    if (
      (function () {
        ...
        try {
          ...
          g = k.next();
          return g.done || g.value[0] == c || g.value[0].x != 4 || g.value[1] != g.value[0]
            ? !1
            : k.next().done;
        } catch (f) {
          return !1;
    ...
    return a
      ...
      : function (b, c, d) {
          ...
          if (typeof g == 'function') {
            b = g.call(b);
            for (var f = 0; !(g = b.next()).done; ) k.push(c.call(d, g.value, f++));
          } else for (g = b.length, f = 0; f < g; f++) k.push(c.call(d, b[f], f));
          return k;
        };
  }); /*
  ...
  K.prototype.addOnDisposeCallback = function (a, b) {
    this.i
      ? b !== void 0
        ? a.call(b)
        : a()
      : (this.j || (this.j = []), b && (a = a.bind(b)), this.j.push(a));
  };
...
*/
  ...
  function eb() {
    for (
      var a = S(), b = RegExp('([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?', 'g'), c = [], d;
      (d = b.exec(a));
    ...
    if (cb())
      ...
      b =
        ((S().indexOf('Chrome') != -1 || S().indexOf('CriOS') != -1) &&
          (cb() || S().indexOf('Edge') == -1)) ||
        S().indexOf('Silk') != -1;
  ...
  n.F = function (a) {
    ...
    if (b) {
      ...
      this.m != 0
        ...
        : (c && va(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2]);
    }
    return !!b;
  };
  n.G = function (a, b) {
    ...
    if (c) {
      var d = Array(arguments.length - 1),
        k = arguments.length,
        g;
      for (g = 1; g < k; g++) d[g - 1] = arguments[g];
      if (this.A) for (g = 0; g < c.length; g++) ((k = c[g]), hb(this.g[k + 1], this.g[k + 2], d));
      else {
        this.m++;
        try {
          for (g = 0, k = c.length; g < k && !this.i; g++) {
            var f = c[g];
            this.g[f + 1].apply(this.g[f + 2], d);
          }
        } finally {
          if ((this.m--, this.l.length > 0 && this.m == 0)) for (; (c = this.l.pop()); ) this.F(c);
        }
      }
      return g != 0;
    }
  ...
  n.clear = function (a) {
    if (a) {
      var b = this.h[a];
      b && (b.forEach(this.F, this), delete this.h[a]);
  ...
  function kb(a, b, c) {
    if (Array.isArray(b)) for (var d = 0; d < b.length; d++) kb(a, String(b[d]), c);
            ...
            Promise.all(
              b.map(function (d) {
                ...
                return F(function (g) {
                  ...
                  g.g != 2
                    ? ((k = g.m), k.state === 'prompt' && a.g.push(d), (g.g = 0), (g.l = 0))
                    : ((g.l = 0), (g.i = null), (g.g = 0));
                });
              })
            ),
            4
  ...
  var W = {},
    ...
    rb = {};
  function sb() {
    for (var a = x(qb), b = a.next(); !b.done; b = a.next()) ((b = b.value), b());
  }
  function tb(a, b) {
    return a.tagName.toLowerCase().substring(0, 3) === 'yt:'
      ? a.getAttribute(b)
      : a.dataset
        ? a.dataset[b]
  ...
  function X(a, b) {
    ...
    this.id = pa(this);
    b = Object.assign({ title: 'video player', videoId: '', width: 640, height: 360 }, b || {});
    var c = document;
    if ((a = typeof a === 'string' ? c.getElementById(a) : a)) {
      ...
      if (!c) {
        ...
        if (xb.yt_embedsEnableIframeSrcWithIntent) {
          var e = e === void 0 ? Ta : e;
          a: if (((e = e === void 0 ? Ta : e), f instanceof L)) e = f;
          else {
            for (a = 0; a < e.length; ++a)
              if (((c = e[a]), c instanceof Sa && c.S(f))) {
                e = new L(f);
                break a;
              }
            e = void 0;
      ...
      if (window.postMessage) {
        ...
        Ab(this);
        b = Y(this, 'events');
        for (var h in b) b.hasOwnProperty(h) && this.addEventListener(h, b[h]);
  ...
  function Gb(a) {
    ...
    a =
      Math.max(
        0,
        Math.min(b.bottom, window.innerHeight || document.documentElement.clientHeight) -
          Math.max(b.top, 0)
      ) *
      Math.max(
        0,
        Math.min(b.right, window.innerWidth || document.documentElement.clientWidth) -
          Math.max(b.left, 0)
      );
    a = (b = b.height * b.width) ? a / b : 0;
    return document.visibilityState === 'hidden' || a < 0.5
      ? 1
      : a < 0.75
        ? 2
        : a < 0.85
  ...
  function Cb(a, b) {
    a.C[b] || ((a.C[b] = !0), Db(a, 'addEventListener', [b]));
  }
    ...
    if (this.g.contentWindow)
      try {
        ...
        if (c.name && c.name === 'SyntaxError')
          (c.message && c.message.indexOf("target origin ''") > 0) ||
  ...
  function yb(a, b) {
    ...
    window !== window.top &&
      document.referrer &&
      (c.widget_referrer = document.referrer.substring(0, 256));
    ...
    window.location.href &&
      ua(['debugjs', 'debugcss'], function (k) {
        ...
        b: {
          ...
          for (var h = k.length; (e = g.indexOf(k, e)) >= 0 && e < f; ) {
            ...
            if (l == 38 || l == 63)
              if (((l = g.charCodeAt(e + h)), !l || l == 61 || l == 38 || l == 35)) break b;
            e += h + 1;
          }
          e = -1;
        }
  ...
  function Hb(a, b) {
    if (I(b)) {
      ...
      a.playerInfo.hasOwnProperty('videoData') &&
        ((b = a.playerInfo.videoData),
        b.hasOwnProperty('title') && b.title
          ? ((b = b.title),
            b !== a.videoTitle && ((a.videoTitle = b), a.g.setAttribute('title', b)))
          : ((a.videoTitle = ''), a.g.setAttribute('title', 'YouTube ' + Y(a, 'title'))));
    }
  }
  function Ib(a, b) {
    b = x(b);
    for (var c = b.next(), d = {}; !c.done; d = { u: void 0 }, c = b.next())
      ((d.u = c.value),
        a[d.u] ||
          (d.u === 'getCurrentTime'
            ? (a[d.u] = function () {
                ...
                if (this.playerInfo.playerState === 1) {
                  var g =
                    (Date.now() / 1e3 - this.playerInfo.currentTimeLastUpdated_) *
  ...
  function Kb(a) {
    if (a.tagName.toLowerCase() !== 'iframe') {
      var b = tb(a, 'videoid');
      b && ((b = { videoId: b, width: tb(a, 'width'), height: tb(a, 'height') }), new X(a, b));
    }
  }
  function Fb(a, b, c) {
    Z ||
        ...
        a: if (Jb.has(d.origin)) {
          ...
          if (g && d.origin === g.O)
            switch (
              ((d = g.U),
              (d.m = !0),
              d.m && (ua(d.l, d.sendMessage, d), (d.l.length = 0)),
              (g = k.event),
              (k = k.info),
              g)
            ) {
              case 'apiInfoDelivery':
                if (I(k)) for (var f in k) k.hasOwnProperty(f) && (d.v[f] = k[f]);
                break;
              case 'infoDelivery':
                Hb(d, k);
                break;
              ...
              case 'readyToListen':
                ...
                break;
              default:
                d.i.i || ((f = { target: d, data: k }), d.i.G(g, f), ub('player.' + g, f));
            }
        }
      }));
    Z[b] = { U: a, O: c };
  ...
  J('YT.subscribe', function (a, b, c) {
    V.subscribe(a, b, c);
    rb[a] = !0;
    for (var d in W) W.hasOwnProperty(d) && Bb(W[d], a);
  });
  ...
  (typeof YTConfig !== 'undefined' && YTConfig.parsetags && YTConfig.parsetags !== 'onload') ||
    sb();
  var Mb = H.onYTReady;
  Mb && Mb();
